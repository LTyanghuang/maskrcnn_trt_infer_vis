...
class ModelConvertor(object):
    ...
    def load_engine(self, engine_path):
        ...
        ctypes.CDLL('/home/yhuang/TensorRT-7.2.3.4/lib/libnvinfer_plugin.so', mode=ctypes.RTLD_GLOBAL)
        ctypes.CDLL('/home/yhuang/trt_projects/LGTPlugin/build/libFasterRCNNKernels.so', mode=ctypes.RTLD_GLOBAL)
